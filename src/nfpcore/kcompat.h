...
#define COMPAT_SLELINUX 0
#endif
#ifndef SLEL_LOCALVER_X
#define SLEL_LOCALVER_X 0
#endif
#ifndef SLEL_LOCALVER_Y
#define SLEL_LOCALVER_Y 0
#endif
...
#define VER_KERN_LT(x, y, ...)	(LINUX_VERSION_CODE <  KERNEL_VERSION(x, y, (0, ##__VA_ARGS__)))
#define VER_KERN_GE(x, y, ...)	(LINUX_VERSION_CODE >= KERNEL_VERSION(x, y, (0, ##__VA_ARGS__)))
#define VER_KERN_EQ(x, y, ...)						\
	(VER_KERN_GE(x, y, ##__VA_ARGS__) && (VER_KERN_LT(x, y, (0, ##__VA_ARGS__) + 1)))
...
#define VER_NON_RHEL_LT(x, y, ...)	(!RHEL_RELEASE_CODE && VER_KERN_LT(x, y, ##__VA_ARGS__))
#define VER_NON_RHEL_GE(x, y, ...)	(!RHEL_RELEASE_CODE && VER_KERN_GE(x, y, ##__VA_ARGS__))
...
#define VER_NON_SLEL_GE(x, y)	(!COMPAT_SLELINUX && VER_KERN_GE(x, y))
#define VER_NON_SLEL_LT(x, y)	(!COMPAT_SLELINUX && VER_KERN_LT(x, y))
#define VER_NON_SLEL_EQ(x, y)	(!COMPAT_SLELINUX && VER_KERN_EQ(x, y))
#define VER_SLEL_GE(x, y, z)	(COMPAT_SLELINUX && VER_KERN_GE(x, y, z))
#define VER_SLEL_LT(x, y, z)	(COMPAT_SLELINUX && VER_KERN_LT(x, y, z))
#define VER_SLEL_EQ(x, y, z)	(COMPAT_SLELINUX && VER_KERN_EQ(x, y, z))
#define VER_NON_RHEL_OR_SLEL_LT(x, y)					\
	(!RHEL_RELEASE_CODE && !COMPAT_SLELINUX && VER_KERN_LT(x, y))
...
#define SLEL_LOCALVER_MERGE(a, b) (((a) << 8) + (b))
#define SLEL_LOCALVER_EXTRACT\
	SLEL_LOCALVER_MERGE(SLEL_LOCALVER_X, SLEL_LOCALVER_Y)
#define SLEL_LOCALVER_LT(v, p, s, x, y) \
